...
>>>>>>> 374ac94c26c594d94f76282b3ab839a3f94a5c75
    ...
    const activeItemStyle = {
        backgroundColor: darkTheme ? '#800000' : '#f0f0f0',
        color: darkTheme ? '#ffffff' : '#000000',
    };
    ...
    const handleOk = () => {
        ...
        // Aquí se podría añadir la lógica para cerrar sesión, por ejemplo:
    ...
    return (
        <>
            ...
            >
                ...
                <Menu.Item key="logout" icon={<LogoutOutlined style={{ color: itemStyle.color }} />} onClick={showConfirm}>
